...
class MemberRepositoryTest {
    ...
    void basicTest() {
        ...
        List<Member> resultList1 = memberRepository.findAll();
        assertThat(resultList1).containsExactly(member);

        List<Member> resultList2 = memberRepository.findByName("member1");
    ...
    void searchPageSimple() {
        ...
        Page<MemberTeamDto> resultList = memberRepository.searchPageSimple(condition, pageRequest);
        assertThat(resultList).extracting("username").containsExactly("member1", "member2", "member3");
